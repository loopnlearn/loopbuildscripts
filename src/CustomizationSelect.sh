...
add_customization "main only - not needed for dev: CAGE: Upload Pod Start to Nightscout" "omnipod_cage"
add_customization "main only - not needed for dev: SAGE: Upload Dexcom Sensor Start to Nightscout" "dexcom_sage"
...
add_customization "main only - not needed for dev: Limit CGM driven Loop Cycle to 5 minutes" "limit_loop_cycle_time"
...
add_customization "main only - not needed for dev: Algorithm Experiments" "algorithm_experiments" "message_for_algorithm_experiments"
